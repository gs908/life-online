  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-800">Guild Management</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white p-4 rounded-xl shadow-md border border-slate-200">
            ...
            {redemptionHistory.length === 0 ? (
              <p className="text-sm text-slate-400 italic text-center py-4">No privileges used yet.</p>
            ) : (
        ...
        <div className="lg:col-span-2">
          ...
          {activeQuest && (
            <div className="mb-6">
              <h3 className="text-lg font-bold text-blue-800 mb-2 flex items-center gap-2">
                <Sparkles size={18} /> Currently Adventuring
              </h3>
              <QuestCard
                task={activeQuest}
          ...
          <h3 className="text-lg font-bold text-slate-700 mb-4">Pending Review</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            {pendingTasks.length === 0 && (
              <p className="text-slate-400 text-sm col-span-2 bg-slate-50 p-4 rounded border border-dashed text-center">No quests waiting for review.</p>
            )}
          </div>

          <h3 className="text-lg font-bold text-slate-700 mb-4">Available Quests Board</h3>
